...
public:
    ...
    void TestVertexBasedMonolayerWithDeltaNotch()
    {
        ...
        for (unsigned elem_index=0; elem_index<p_mesh->GetNumElements(); elem_index++)
        {
            ...
            double birth_time = -RandomNumberGenerator::Instance()->ranf()*(p_cc_model->GetTransitCellG1Duration() + p_cc_model->GetSG2MDuration());
            
            p_cell->SetApoptosisTime(0.5);
        ...
        MAKE_PTR_ARGS(AreaVertexCellKiller<2>, p_killer, (&cell_population, 0.80));
