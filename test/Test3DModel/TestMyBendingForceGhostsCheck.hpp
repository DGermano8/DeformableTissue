...
public:
    ...
    void TestPeriodicCubeWithGhosts() throw (Exception)
    {
        ...
        double periodic_width = (double) (width+0.0)*width_space + 0.10;
        double periodic_height = (double) (height+0.0)*height_space + 0.10;
...
*/
         ...
         ++cell_iter)
        {
            ...
            //PRINT_VECTOR(real_node_location);
            //PRINT_VECTOR(cell_population.GetNode(real_node_index)->rGetAppliedForce());
