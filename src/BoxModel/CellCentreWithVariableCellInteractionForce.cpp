#include "CellCentreWithVariableCellInteractionForce.hpp"
#include "Debug.hpp"
#include <iostream>
#include <fstream>
...
CellCentreWithVariableCellInteractionForce<DIM>::CellCentreWithVariableCellInteractionForce()
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetCellTypeDependentSprings(bool useCellTypeDependentSprings,
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetEdgeBasedSpringConstant(bool useEdgeBasedSpringConstant)
{
    assert(DIM == 2);
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetMutantSprings(bool useMutantSprings, double mutantMutantMultiplier, double normalMutantMultiplier)
{
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetBetaCateninSprings(bool useBCatSprings)
{
    mUseBCatSprings = useBCatSprings;
}

template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetApoptoticSprings(bool useApoptoticSprings)
{
    mUseApoptoticSprings = useApoptoticSprings;
}

template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetBasalLaminaParameter(double basalLaminaParameter)
{
	mBasalLaminaParameter = basalLaminaParameter;
}

template<unsigned DIM>
double CellCentreWithVariableCellInteractionForce<DIM>::GetBasalLaminaParameter()
{
	return mBasalLaminaParameter;
}

template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetUseOneWaySprings(bool useOneWaySprings)
{
	mUseOneWaySprings = useOneWaySprings;
}

template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::SetTransitTransitMultiplier(double transitTransitMultiplier)
{
	mTransitTransitMultiplier = transitTransitMultiplier;
}

template<unsigned DIM>
double CellCentreWithVariableCellInteractionForce<DIM>::GetTransitTransitMultiplier()
{
	return mTransitTransitMultiplier;
}

template<unsigned DIM>
double CellCentreWithVariableCellInteractionForce<DIM>::VariableSpringConstantMultiplicationFactor(unsigned nodeAGlobalIndex, unsigned nodeBGlobalIndex,
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::OutputForceParameters(out_stream& rParamsFile)
{
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::RemoveDuplicates1D(std::vector<unsigned>& vectorWithDuplicates)
{
...
template<unsigned DIM>
std::vector<c_vector<unsigned, DIM> > CellCentreWithVariableCellInteractionForce<DIM>::GetTransitDifferentiatedPairs(AbstractCellPopulation<DIM>& rCellPopulation)
{
    MeshBasedCellPopulation<DIM>* p_tissue = static_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
bool CellCentreWithVariableCellInteractionForce<DIM>::DoesElementContainGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned elementIndex)
{
	MeshBasedCellPopulation<DIM>* p_tissue = static_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
double CellCentreWithVariableCellInteractionForce<DIM>::GetCurvatureFromNodePair(AbstractCellPopulation<DIM>& rCellPopulation, unsigned transitNodeIndex, unsigned diffNodeIndex)
{
	MeshBasedCellPopulation<DIM>* p_tissue = static_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::GetOrderedCurvatureVector(AbstractCellPopulation<DIM>& rCellPopulation)
{
	MeshBasedCellPopulation<DIM>* p_tissue = static_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
double CellCentreWithVariableCellInteractionForce<DIM>::FindCurvature(c_vector<double, DIM> leftMidpoint,
...
template<unsigned DIM>
unsigned CellCentreWithVariableCellInteractionForce<DIM>::GetNumContainingElementsWithoutGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	MeshBasedCellPopulation<DIM>* p_tissue = static_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
void CellCentreWithVariableCellInteractionForce<DIM>::AddForceContribution(std::vector<c_vector<double, DIM> >& rForces,
...
template<unsigned DIM>
c_vector<double, DIM> CellCentreWithVariableCellInteractionForce<DIM>::CalculateForceBetweenNodes(unsigned nodeAGlobalIndex,
...
template class CellCentreWithVariableCellInteractionForce<1>;
template class CellCentreWithVariableCellInteractionForce<2>;
template class CellCentreWithVariableCellInteractionForce<3>;
