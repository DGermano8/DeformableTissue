...
PeriodicBoxBoundaryCondition3d::PeriodicBoxBoundaryCondition3d(AbstractCellPopulation<3>* pCellPopulation)
...
PeriodicBoxBoundaryCondition3d::~PeriodicBoxBoundaryCondition3d()
{
} 


//void PeriodicBoxBoundaryCondition3d::ImposeBoundaryCondition(const std::vector< c_vector<double, 3> >& rOldLocations)
void PeriodicBoxBoundaryCondition3d::ImposeBoundaryCondition(const std::map<Node<3>*, c_vector<double, 3> >& rOldLocations)
{	
...
bool PeriodicBoxBoundaryCondition3d::VerifyBoundaryCondition()
{
...
void PeriodicBoxBoundaryCondition3d::SetMaxHeightForPinnedCells(double maxHeightForPinnedCells)
{
	mMaxHeightForPinnedCells = maxHeightForPinnedCells;
}

double PeriodicBoxBoundaryCondition3d::GetMaxHeightForPinnedCells()
{
	return mMaxHeightForPinnedCells;
}

void PeriodicBoxBoundaryCondition3d::SetCellPopulationWidth(double cellPopulationWidth)
{
	mCellPopulationWidth = cellPopulationWidth;
}

double PeriodicBoxBoundaryCondition3d::GetCellPopulationWidth()
{
	return mCellPopulationWidth;
}

void PeriodicBoxBoundaryCondition3d::SetCellPopulationDepth(double cellPopulationDepth)
{
	mCellPopulationDepth = cellPopulationDepth;
}

double PeriodicBoxBoundaryCondition3d::GetCellPopulationDepth()
{
	return mCellPopulationDepth;
}


void PeriodicBoxBoundaryCondition3d::OutputCellPopulationBoundaryConditionParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(PeriodicBoxBoundaryCondition3d)
