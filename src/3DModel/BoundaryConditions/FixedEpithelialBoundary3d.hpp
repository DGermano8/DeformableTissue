...
public:
     ...
     */
    FixedEpithelialBoundary3d(AbstractCellPopulation<3>* pCellPopulation, double maxHeightForPinnedCells,
    ...
    Archive & ar, FixedEpithelialBoundary3d * t, const unsigned int file_version)
{
    ...
    ::new(t)FixedEpithelialBoundary3d(p_cell_population, maxHeightForPinnedCells, cellPopulationWidth, cellPopulationDepth);
}
}
} // namespace ...
