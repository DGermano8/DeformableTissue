#ifndef PERIODICBOXBOUNDARYCONDITION3D_HPP_
#define PERIODICBOXBOUNDARYCONDITION3D_HPP_
...
class PeriodicBoxBoundaryCondition3d : public AbstractCellPopulationBoundaryCondition<3>
{
private:
...
public:
     ...
     */
	PeriodicBoxBoundaryCondition3d(AbstractCellPopulation<3>* pCellPopulation);

    /**
     * Destructor.
     */
    ~PeriodicBoxBoundaryCondition3d();
...
inline void save_construct_data(
    Archive & ar, const PeriodicBoxBoundaryCondition3d * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, PeriodicBoxBoundaryCondition3d * t, const unsigned int file_version)
{
    ...
    ::new(t)PeriodicBoxBoundaryCondition3d(p_cell_population);
}
}
} // namespace ...

#endif /*PERIODICBOXBOUNDARYCONDITION3D_HPP_*/
