#include "FixedBoundaries3d.hpp"
    ...
    FixedBoundaries3d::FixedBoundaries3d(AbstractCellPopulation<3>* pCellPopulation, double maxHeightForPinnedCells, double cellPopulationWidth, double cellPopulationDepth)
...
//        mpStaticCastCellPopulation = static_cast<MeshBasedCellPopulation<3>*>(&mpCellPopulation);
    ...
    double FixedBoundaries3d::GetMaxHeightForPinnedCells()
    {
    	return mMaxHeightForPinnedCells;
    }

    double FixedBoundaries3d::GetCellPopulationWidth()
    {
    	return mCellPopulationWidth;
    }

    double FixedBoundaries3d::GetCellPopulationDepth()
    {
