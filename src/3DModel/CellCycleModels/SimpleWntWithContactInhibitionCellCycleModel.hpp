#ifndef SIMPLEWNTWITHCONTACTINHIBITIONCELLCYCLEMODEL_HPP_
#define SIMPLEWNTWITHCONTACTINHIBITIONCELLCYCLEMODEL_HPP_
...
/**
 *  Simple Wnt-dependent cell cycle model with area-based contact inhibition of mitosis, but
 *  otherwise stochastic G1 duration (chosen from uniform distribution)
 */
class SimpleWntWithContactInhibitionCellCycleModel : public AbstractSimpleCellCycleModel
{
private:
    ...
    /**
     * Fraction of equilibrium cell area below which a cell cannot undergo division (stays in G1).
     */
...
public:
     ...
     */
    SimpleWntWithContactInhibitionCellCycleModel();
...
#endif /*SIMPLEWNTWITHCONTACTINHIBITIONCELLCYCLEMODEL_HPP_*/
