#ifndef StandardUniformCellKiller3dWithGhostNodes_HPP_
#define StandardUniformCellKiller3dWithGhostNodes_HPP_
 ...
 */
class StandardUniformCellKiller3dWithGhostNodes : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    StandardUniformCellKiller3dWithGhostNodes(AbstractCellPopulation<3>* pCellPopulation, double probabilityOfDeathInAnHour = 0.5,
    		double minXBoundary = 0.0, double maxXBoundary = 50.0, double minYBoundary = 0.0, double maxYBoundary = 50.0, double cellPop = 0.0);

	// Destructor
	~StandardUniformCellKiller3dWithGhostNodes();
...
inline void save_construct_data(
    Archive & ar, const StandardUniformCellKiller3dWithGhostNodes * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, StandardUniformCellKiller3dWithGhostNodes * t, const unsigned int file_version)
{
    ...
    ::new(t)StandardUniformCellKiller3dWithGhostNodes(p_tissue);
}
}
}

#endif /* StandardUniformCellKiller3dWithGhostNodes_HPP_ */
