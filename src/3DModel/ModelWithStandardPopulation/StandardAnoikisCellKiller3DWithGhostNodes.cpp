 ...
 *
 */
StandardAnoikisCellKiller3DWithGhostNodes::StandardAnoikisCellKiller3DWithGhostNodes(AbstractCellPopulation<3>* pCrypt,
																	double cut_off,
...
StandardAnoikisCellKiller3DWithGhostNodes::~StandardAnoikisCellKiller3DWithGhostNodes()
{
//    mAnoikisOutputFile->close();
}

void StandardAnoikisCellKiller3DWithGhostNodes::SetOutputDirectory(std::string outputDirectory)
{
...
std::string StandardAnoikisCellKiller3DWithGhostNodes::GetOutputDirectory()
{
 ...
 */
std::set<unsigned> StandardAnoikisCellKiller3DWithGhostNodes::GetNeighbouringNodeIndices(unsigned nodeIndex)
{
 ...
 */
bool StandardAnoikisCellKiller3DWithGhostNodes::HasCellPoppedUp(unsigned nodeIndex)
{
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
 ...
 */
std::vector<c_vector<unsigned,2> > StandardAnoikisCellKiller3DWithGhostNodes::RemoveByAnoikis()
{
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
 ...
 * cells
*/
void StandardAnoikisCellKiller3DWithGhostNodes::CheckAndLabelCellsForApoptosisOrDeath()
{
	// TRACE("Anoikis In")
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
...
void StandardAnoikisCellKiller3DWithGhostNodes::SetNumberCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
...
unsigned StandardAnoikisCellKiller3DWithGhostNodes::GetNumberCellsRemovedByAnoikis()
{
	return mCellsRemovedByAnoikis;
}

/* Data stored: time - node_index - x - y - z */
void StandardAnoikisCellKiller3DWithGhostNodes::SetLocationsOfCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
...
std::vector<c_vector<double,5> > StandardAnoikisCellKiller3DWithGhostNodes::GetLocationsOfCellsRemovedByAnoikis()
{
	return mLocationsOfAnoikisCells;
}

void StandardAnoikisCellKiller3DWithGhostNodes::OutputCellKillerParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(StandardAnoikisCellKiller3DWithGhostNodes)
