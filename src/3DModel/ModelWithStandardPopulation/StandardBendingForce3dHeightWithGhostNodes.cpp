...
StandardBendingForce3dHeightWithGhostNodes::StandardBendingForce3dHeightWithGhostNodes()
    : AbstractForce<3>(),
...
void StandardBendingForce3dHeightWithGhostNodes::SetOutputDirectory(std::string outputDirectory)
{
	mOutputDirectory = outputDirectory;
}

void StandardBendingForce3dHeightWithGhostNodes::SetBasementMembraneParameter(double basementMembraneParameter)
{
	mBasementMembraneParameter = basementMembraneParameter;
}

double StandardBendingForce3dHeightWithGhostNodes::GetBasementMembraneParameter()
{
	return mBasementMembraneParameter;
}

void StandardBendingForce3dHeightWithGhostNodes::SetExponentParameter(double exponentParameter)
{
	mExponentParameter = exponentParameter;
}

double StandardBendingForce3dHeightWithGhostNodes::GetExponentParameter()
{
	return mExponentParameter;
}

void StandardBendingForce3dHeightWithGhostNodes::SetHeightDependantCurvatureParameter(double heightparameter)
{
	mHeightDependantCurvatureParameter = heightparameter;
}

double StandardBendingForce3dHeightWithGhostNodes::GetHeightDependantCurvatureParameter()
{
	return mHeightDependantCurvatureParameter;
}

void StandardBendingForce3dHeightWithGhostNodes::SetCircularNonZeroTargetCurvatureRegion(bool setNonZeroTargetCurvatureRegion, double nonZeroTargetCurvature,
...
bool StandardBendingForce3dHeightWithGhostNodes::GetWhetherToSetNonZeroTargetCurvatureRegion()
{
	return mSetNonZeroTargetCurvatureRegion;
}

double StandardBendingForce3dHeightWithGhostNodes::GetNonZeroTargetCurvature()
{
	return mNonZeroTargetCurvature;
}

double StandardBendingForce3dHeightWithGhostNodes::GetRadiusOfNonZeroTargetCurvatureRegion()
{
	return mRadiusOfNonZeroTargetCurvatureRegion;
}

double StandardBendingForce3dHeightWithGhostNodes::GetXCoordinateOfCentreOfNonZeroTargetCurvatureRegion()
{
	return mXCoordinateOfCentreOfNonZeroTargetCurvatureRegion;
}

double StandardBendingForce3dHeightWithGhostNodes::GetYCoordinateOfCentreOfNonZeroTargetCurvatureRegion()
{
 ...
 */
void StandardBendingForce3dHeightWithGhostNodes::RemoveDuplicates1D(std::vector<unsigned>& rVectorWithDuplicates)
{
 ...
 */
std::vector<c_vector<unsigned, 2> > StandardBendingForce3dHeightWithGhostNodes::GetEpithelialTissuePairs(AbstractCellPopulation<3>& rCellPopulation)
{
...
std::vector<c_vector<unsigned, 10> > StandardBendingForce3dHeightWithGhostNodes::GetEpithelialNeighbours(std::vector<c_vector<unsigned, 3> > rEpithelialMeshVector, unsigned number_of_cells)
{
...
std::vector<c_vector<unsigned, 3> > StandardBendingForce3dHeightWithGhostNodes::GetEpithelialMesh(AbstractCellPopulation<3>& rCellPopulation)
{
// Get a pointer to this node in mpExtendedMesh
...
std::vector<c_vector<double, 3> > StandardBendingForce3dHeightWithGhostNodes::FitPlaneAndFindImage(AbstractCellPopulation<3>& rCellPopulation, std::vector<unsigned> second_order_neighs,  unsigned cell_i)
{
...
// ORIGINAL
// c_vector<double, 3> StandardBendingForce3dHeightWithGhostNodes::GetForceDueToDiscreteCurvature(AbstractCellPopulation<3>& rCellPopulation, std::vector<c_vector<unsigned, 3> > rEpithelialMeshVector, std::vector<unsigned> first_order_neighs,  std::vector<unsigned> second_order_neighs, std::vector<c_vector<double, 3> > image_location, unsigned cell_i, unsigned num_cells)
// {
...
// c_vector<unsigned, 2> StandardBendingForce3dHeightWithGhostNodes::GetMaxMinEpithelialCells(AbstractCellPopulation<3>& rCellPopulation)
// {
 ...
 */
bool StandardBendingForce3dHeightWithGhostNodes::DoesElementContainGhostNodes(AbstractCellPopulation<3>& rCellPopulation, unsigned elementIndex)
{
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*>(&rCellPopulation);
 ...
 */
bool StandardBendingForce3dHeightWithGhostNodes::DoesElementContainLongEdge(AbstractCellPopulation<3>& rCellPopulation, unsigned elementIndex, double maxEdgeLength)
{
...
void StandardBendingForce3dHeightWithGhostNodes::AddForceContribution(AbstractCellPopulation<3>& rCellPopulation)
{
	// TRACE("Adding force");
...
double StandardBendingForce3dHeightWithGhostNodes::GetPeriodicDomainWidth()
{
	return mPeriodicDomainWidth;
}

void StandardBendingForce3dHeightWithGhostNodes::SetPeriodicDomainWidth(double periodicDomainWidth)
{
	mPeriodicDomainWidth = periodicDomainWidth;
}

double StandardBendingForce3dHeightWithGhostNodes::GetPeriodicDomainDepth()
{
	return mPeriodicDomainDepth;
}

void StandardBendingForce3dHeightWithGhostNodes::SetPeriodicDomainDepth(double periodicDomainDepth)
{
	mPeriodicDomainDepth = periodicDomainDepth;
}


void StandardBendingForce3dHeightWithGhostNodes::OutputForceParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(StandardBendingForce3dHeightWithGhostNodes)
