#ifndef StandardAnoikisCellKiller3DWithGhostNodes_HPP_
#define StandardAnoikisCellKiller3DWithGhostNodes_HPP_
 ...
 */
class StandardAnoikisCellKiller3DWithGhostNodes : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    StandardAnoikisCellKiller3DWithGhostNodes(AbstractCellPopulation<3>* pCellPopulation, double cut_off = 100.0, double tissueWidth = 10.0, double tissueDepth = 10.0);

	// Destructor
	~StandardAnoikisCellKiller3DWithGhostNodes();
...
{
/**
 * Serialize information required to construct a StandardAnoikisCellKiller3DWithGhostNodes.
 */
template<class Archive >
inline void save_construct_data(
    Archive & ar, const StandardAnoikisCellKiller3DWithGhostNodes * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, StandardAnoikisCellKiller3DWithGhostNodes * t, const unsigned int file_version)
{
    ...
    ::new(t)StandardAnoikisCellKiller3DWithGhostNodes(p_tissue);
}
}
}

#endif /*StandardAnoikisCellKiller3DWithGhostNodes_HPP_*/
