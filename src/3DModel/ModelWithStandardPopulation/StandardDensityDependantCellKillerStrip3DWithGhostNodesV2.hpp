#ifndef StandardDensityDependantCellKillerStrip3DWithGhostNodesV2_HPP_
#define StandardDensityDependantCellKillerStrip3DWithGhostNodesV2_HPP_
 ...
 */
class StandardDensityDependantCellKillerStrip3DWithGhostNodesV2 : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    StandardDensityDependantCellKillerStrip3DWithGhostNodesV2(AbstractCellPopulation<3>* pCellPopulation, double cut_off = 100.0, double density_threshold = 0.0, double tissueWidth = 10.0, double tissueDepth = 10.0);

	// Destructor
	~StandardDensityDependantCellKillerStrip3DWithGhostNodesV2();
...
{
/**
 * Serialize information required to construct a StandardDensityDependantCellKillerStrip3DWithGhostNodesV2.
 */
template<class Archive >
inline void save_construct_data(
    Archive & ar, const StandardDensityDependantCellKillerStrip3DWithGhostNodesV2 * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, StandardDensityDependantCellKillerStrip3DWithGhostNodesV2 * t, const unsigned int file_version)
{
    ...
    ::new(t)StandardDensityDependantCellKillerStrip3DWithGhostNodesV2(p_tissue);
}
}
}

#endif /*StandardDensityDependantCellKillerStrip3DWithGhostNodesV2_HPP_*/
