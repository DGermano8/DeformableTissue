 ...
 *
 */
StandardUniformCellKiller3dWithGhostNodes::StandardUniformCellKiller3dWithGhostNodes(AbstractCellPopulation<3>* pCrypt, double probabilityOfDeathInAnHour,
...
StandardUniformCellKiller3dWithGhostNodes::~StandardUniformCellKiller3dWithGhostNodes()
{
}

void StandardUniformCellKiller3dWithGhostNodes::SetOutputDirectory(std::string outputDirectory)
{
...
std::string StandardUniformCellKiller3dWithGhostNodes::GetOutputDirectory()
{
 ...
 */
std::vector<c_vector<unsigned,2> > StandardUniformCellKiller3dWithGhostNodes::RemoveByRandomSelection()
{
...
void StandardUniformCellKiller3dWithGhostNodes::CheckAndLabelSingleCellForApoptosis(CellPtr pCell)
{
    // We assume a constant time step
    double death_prob_this_timestep = 1.0 - pow((1.0 - mProbabilityOfDeathInAnHour), SimulationTime::Instance()->GetTimeStep());
...
*/
void StandardUniformCellKiller3dWithGhostNodes::CheckAndLabelCellsForApoptosisOrDeath()
{
...
void StandardUniformCellKiller3dWithGhostNodes::OutputCellKillerParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(StandardUniformCellKiller3dWithGhostNodes)
