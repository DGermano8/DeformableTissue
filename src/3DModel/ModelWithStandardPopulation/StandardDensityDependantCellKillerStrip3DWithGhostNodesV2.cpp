 ...
 */
StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::StandardDensityDependantCellKillerStrip3DWithGhostNodesV2(AbstractCellPopulation<3>* pCrypt, double cut_off, double density_threshold, double cellPopulationWidth, double cellPopulationDepth)
...
StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::~StandardDensityDependantCellKillerStrip3DWithGhostNodesV2()
{
//    mAnoikisOutputFile->close();
}

void StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::SetOutputDirectory(std::string outputDirectory)
{
...
std::string StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetOutputDirectory()
{
 ...
 */
std::set<unsigned> StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetNeighbouringNodeIndices(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap, unsigned nodeIndex)
{
 ...
 */
c_vector<double,2> StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::IsCellTooSmall(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap, unsigned nodeIndex, std::vector<unsigned> first_order_neighs)
{
...
std::vector<c_vector<unsigned, 3> > StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetEpithelialMesh(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap)
{
...
std::vector<c_vector<unsigned, 10> > StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetEpithelialNeighbours(std::vector<c_vector<unsigned, 3> > rEpithelialMeshVector, unsigned number_of_cells)
{
 ...
 */
std::vector<c_vector<unsigned,2> > StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::RemoveByAnoikis()
{
 ...
 * cells
*/
void StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::CheckAndLabelCellsForApoptosisOrDeath()
{
...
void StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::SetNumberCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
...
unsigned StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetNumberCellsRemovedByAnoikis()
{
	return mCellsRemovedByAnoikis;
}

/* Data stored: time - node_index - x - y - z */
void StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::SetLocationsOfCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
	MeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<MeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
...
std::vector<c_vector<double,5> > StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::GetLocationsOfCellsRemovedByAnoikis()
{
	return mLocationsOfAnoikisCells;
}

void StandardDensityDependantCellKillerStrip3DWithGhostNodesV2::OutputCellKillerParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(StandardDensityDependantCellKillerStrip3DWithGhostNodesV2)
