...
CryptSimulation3d::CryptSimulation3d(AbstractCellPopulation<3>& rCellPopulation,
...
bool CryptSimulation3d::StoppingEventHasOccurred()
{
 ...
 */
void CryptSimulation3d::RemoveDuplicates1D(std::vector<unsigned>& rVectorWithDuplicates)
{
 ...
 */
c_vector<double,3> CryptSimulation3d::CalculateCellDivisionVector(CellPtr pParentCell)
{
 ...
 */
std::set<unsigned> CryptSimulation3d::GetNeighbouringNodeIndices(unsigned nodeIndex)
{
...
bool CryptSimulation3d::GetInstanceOfNonExistentNode()
{
	return mFoundNonExistentNode;
}

std::vector<c_vector<unsigned, 2> > CryptSimulation3d::GetNeighbouringEpithelialPairs(AbstractCellPopulation<3>& rCellPopulation)
{
...
void CryptSimulation3d::WriteVisualizerSetupFile()
{
...
void CryptSimulation3d::SetupWriteEpithelialCoordinateData()
{
...
void CryptSimulation3d::WriteEpithelialCoordinateData(double time)
{
    MeshBasedCellPopulation<3>* p_tissue = static_cast<MeshBasedCellPopulation<3>*>(&mrCellPopulation);
...
std::string CryptSimulation3d::GetDataOutputFile()
{
	return mDataOutputFile;
}

void CryptSimulation3d::SetupSolve()
{
...
void CryptSimulation3d::PostSolve()
{
...
/*
void CryptSimulation3d::AfterSolve()
{	
