#ifndef RANDOMMOTIONFORCEDIRECTED_HPP_
#define RANDOMMOTIONFORCEDIRECTED_HPP_
...
class RandomMotionForceDirected : public AbstractForce<DIM>
{
private :
