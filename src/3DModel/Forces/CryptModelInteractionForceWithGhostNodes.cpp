#include "CryptModelInteractionForceWithGhostNodes.hpp"
#include "Debug.hpp"
#include <cmath>
#include <list>
#include <fstream>
...
CryptModelInteractionForceWithGhostNodes<DIM>::CryptModelInteractionForceWithGhostNodes()
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetCellTypeDependentSprings(bool useCellTypeDependentSprings,
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetEpithelialStromalCellDependentSprings(bool useEpithelialStromalCellDependentSprings,
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetEdgeBasedSpringConstant(bool useEdgeBasedSpringConstant)
{
    assert(DIM == 2);
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetUseOneWaySprings(bool useOneWaySprings)
{
	mUseOneWaySprings = useOneWaySprings;
}

template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetPositionDependentSpringConstants(bool usePositionDependentSpringConstants, double springConstantsMultiplier)
{
...
template<unsigned DIM>
double CryptModelInteractionForceWithGhostNodes<DIM>::GetPositionDependentSpringConstants()
{
	return mSpringConstantsMultiplier;
}

template<unsigned DIM>
double CryptModelInteractionForceWithGhostNodes<DIM>::VariableSpringConstantMultiplicationFactor(unsigned nodeAGlobalIndex,
 ...
 */
template<unsigned DIM>
c_vector<double,2> CryptModelInteractionForceWithGhostNodes<DIM>::GetCryptHeightExtremes(AbstractCellPopulation<DIM>& rCellPopulation)
{
    DomMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::RemoveDuplicates1D(std::vector<unsigned>& rVectorWithDuplicates)
{
 ...
 */
template<unsigned DIM>
bool CryptModelInteractionForceWithGhostNodes<DIM>::DoesElementContainGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned elementIndex)
{
	DomMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
unsigned CryptModelInteractionForceWithGhostNodes<DIM>::GetNumContainingElementsWithoutGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
std::set<unsigned> CryptModelInteractionForceWithGhostNodes<DIM>::GetNeighbouringNodeIndices(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
bool CryptModelInteractionForceWithGhostNodes<DIM>::HasEpithelialCellDetachedFromBasementMembrane(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
...
//                                                                   AbstractCellPopulation<DIM>& rCellPopulation)
void CryptModelInteractionForceWithGhostNodes<DIM>::AddForceContribution(AbstractCellPopulation<DIM>& rCellPopulation)
{
    ...
    std::vector<Node<DIM>*> extended_nodes(num_cells);
...
template<unsigned DIM>
c_vector<double, DIM> CryptModelInteractionForceWithGhostNodes<DIM>::CalculateForceBetweenNodes(unsigned nodeAGlobalIndex,
																						 unsigned nodeBGlobalIndex,
                                                                                         AbstractCellPopulation<DIM>& rCellPopulation)
{
...
template<unsigned DIM>
double CryptModelInteractionForceWithGhostNodes<DIM>::GetPeriodicDomainWidth()
{
	return mPeriodicDomainWidth;
}

template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetPeriodicDomainWidth(double periodicDomainWidth)
{
	mPeriodicDomainWidth = periodicDomainWidth;
}

template<unsigned DIM>
double CryptModelInteractionForceWithGhostNodes<DIM>::GetPeriodicDomainDepth()
{
	return mPeriodicDomainDepth;
}

template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::SetPeriodicDomainDepth(double periodicDomainDepth)
{
...
template<unsigned DIM>
void CryptModelInteractionForceWithGhostNodes<DIM>::OutputForceParameters(out_stream& rParamsFile)
{
...
template class CryptModelInteractionForceWithGhostNodes<1>;
template class CryptModelInteractionForceWithGhostNodes<2>;
template class CryptModelInteractionForceWithGhostNodes<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_SAME_DIMS(CryptModelInteractionForceWithGhostNodes)