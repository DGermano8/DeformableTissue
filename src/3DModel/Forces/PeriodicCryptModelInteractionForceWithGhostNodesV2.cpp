...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetCellTypeDependentSprings(bool useCellTypeDependentSprings,
...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetEpithelialStromalCellDependentSprings(bool useEpithelialStromalCellDependentSprings,
...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetEdgeBasedSpringConstant(bool useEdgeBasedSpringConstant)
{
    assert(DIM == 2);
...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetUseOneWaySprings(bool useOneWaySprings)
{
	mUseOneWaySprings = useOneWaySprings;
}

template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetPositionDependentSpringConstants(bool usePositionDependentSpringConstants, double springConstantsMultiplier)
{
...
template<unsigned DIM>
double PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetPositionDependentSpringConstants()
{
	return mSpringConstantsMultiplier;
}

template<unsigned DIM>
double PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::VariableSpringConstantMultiplicationFactor(unsigned nodeAGlobalIndex,
 ...
 */
template<unsigned DIM>
c_vector<double,2> PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetCryptHeightExtremes(AbstractCellPopulation<DIM>& rCellPopulation)
{
    DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::RemoveDuplicates1D(std::vector<unsigned>& rVectorWithDuplicates)
{
 ...
 */
template<unsigned DIM>
bool PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::DoesElementContainGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned elementIndex)
{
	DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
unsigned PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetNumContainingElementsWithoutGhostNodes(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
std::set<unsigned> PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetNeighbouringNodeIndices(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
 ...
 */
template<unsigned DIM>
bool PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::HasEpithelialCellDetachedFromBasementMembrane(AbstractCellPopulation<DIM>& rCellPopulation, unsigned nodeIndex)
{
	DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>* p_tissue = static_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation);
...
//                                                                   AbstractCellPopulation<DIM>& rCellPopulation)
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::AddForceContribution(AbstractCellPopulation<DIM>& rCellPopulation)
{
...
template<unsigned DIM>
c_vector<double, DIM> PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::CalculateForceBetweenNodes(unsigned nodeAGlobalIndex,
																						 unsigned nodeBGlobalIndex,
                                                                                         AbstractCellPopulation<DIM>& rCellPopulation)
{
...
//     }
 ...
 if (bool(dynamic_cast<DomPeriodicMeshBasedCellPopulationWithGhostNodes<DIM>*>(&rCellPopulation)))
    {
...
template<unsigned DIM>
double PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetPeriodicDomainWidth()
{
	return mPeriodicDomainWidth;
}

template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetPeriodicDomainWidth(double periodicDomainWidth)
{
	mPeriodicDomainWidth = periodicDomainWidth;
}

template<unsigned DIM>
double PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::GetPeriodicDomainDepth()
{
	return mPeriodicDomainDepth;
}

template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::SetPeriodicDomainDepth(double periodicDomainDepth)
{
...
template<unsigned DIM>
void PeriodicCryptModelInteractionForceWithGhostNodesV2<DIM>::OutputForceParameters(out_stream& rParamsFile)
{
...
template class PeriodicCryptModelInteractionForceWithGhostNodesV2<1>;
template class PeriodicCryptModelInteractionForceWithGhostNodesV2<2>;
template class PeriodicCryptModelInteractionForceWithGhostNodesV2<3>;

// Serialization for Boost >= 1.36
#include "SerializationExportWrapperForCpp.hpp"
EXPORT_TEMPLATE_CLASS_SAME_DIMS(PeriodicCryptModelInteractionForceWithGhostNodesV2)