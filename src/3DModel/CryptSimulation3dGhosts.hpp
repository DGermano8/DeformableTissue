#ifndef CRYPTSIMULATION3DGHOSTS_HPP_
#define CRYPTSIMULATION3DGHOSTS_HPP_
...
class CryptSimulation3dGhosts : public OffLatticeSimulation<3>
{
...
public :
     ...
     */
	CryptSimulation3dGhosts(AbstractCellPopulation<3>& rCellPopulation,
...
inline void save_construct_data(
    Archive & ar, const CryptSimulation3dGhosts * t, const unsigned int file_version)
{
...
/**
 * De-serialize constructor parameters and initialise a CryptSimulation3dGhosts
 */
template<class Archive>
inline void load_construct_data(
    Archive & ar, CryptSimulation3dGhosts * t, const unsigned int file_version)
{
    ...
    ::new(t)CryptSimulation3dGhosts(*p_tissue, true, false);
}
}
} // namespace

#endif /* CRYPTSIMULATION3DGHOSTS_HPP_ */
