 ...
 */
DensityDependantCellKillerRadiual3DWithGhostNodesV2::DensityDependantCellKillerRadiual3DWithGhostNodesV2(AbstractCellPopulation<3>* pCrypt, double cut_off, double density_threshold, double cellPopulationWidth, double cellPopulationDepth)
...
DensityDependantCellKillerRadiual3DWithGhostNodesV2::~DensityDependantCellKillerRadiual3DWithGhostNodesV2()
{
//    mAnoikisOutputFile->close();
}

void DensityDependantCellKillerRadiual3DWithGhostNodesV2::SetOutputDirectory(std::string outputDirectory)
{
...
std::string DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetOutputDirectory()
{
 ...
 */
std::set<unsigned> DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetNeighbouringNodeIndices(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap, unsigned nodeIndex)
{
 ...
 */
c_vector<double,2> DensityDependantCellKillerRadiual3DWithGhostNodesV2::IsCellTooSmall(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap, unsigned nodeIndex, std::vector<unsigned> first_order_neighs)
{
	...
	is_too_small_density[1] = average_cell_distance;
...
std::vector<c_vector<unsigned, 3> > DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetEpithelialMesh(MutableMesh<3,3>* ExtendedMesh, std::map<unsigned, unsigned> ExtendedMeshNodeIndexMap)
{
...
std::vector<c_vector<unsigned, 10> > DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetEpithelialNeighbours(std::vector<c_vector<unsigned, 3> > rEpithelialMeshVector, unsigned number_of_cells)
{
 ...
 */
std::vector<c_vector<unsigned,2> > DensityDependantCellKillerRadiual3DWithGhostNodesV2::RemoveByAnoikis()
{
 ...
 * cells
*/
void DensityDependantCellKillerRadiual3DWithGhostNodesV2::CheckAndLabelCellsForApoptosisOrDeath()
{
        ...
        ++cell_iter)
	{
		...
		if(!p_tissue->IsGhostNode(node_index))
		{
			...
			if (p_cell->GetMutationState()->IsType<StromalCellMutationState>()==false && p_cell->GetMutationState()->IsType<WildTypeCellMutationState>()==true)
			{
				...
				if ( pow(x_location - 0.5*mCellPopulationWidth,2) + pow(y_location - 0.5*mCellPopulationDepth,2) >= pow(mCutOffLength,2)  && !(p_cell->IsDead()) && (p_cell->GetAge() >= 1) )
				{
					// // Find the first order neighbours
...
void DensityDependantCellKillerRadiual3DWithGhostNodesV2::SetNumberCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
...
unsigned DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetNumberCellsRemovedByAnoikis()
{
	return mCellsRemovedByAnoikis;
}

/* Data stored: time - node_index - x - y - z */
void DensityDependantCellKillerRadiual3DWithGhostNodesV2::SetLocationsOfCellsRemovedByAnoikis(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
	DomMeshBasedCellPopulationWithGhostNodes<3>* p_tissue = static_cast<DomMeshBasedCellPopulationWithGhostNodes<3>*> (this->mpCellPopulation);
...
std::vector<c_vector<double,5> > DensityDependantCellKillerRadiual3DWithGhostNodesV2::GetLocationsOfCellsRemovedByAnoikis()
{
	return mLocationsOfAnoikisCells;
}

void DensityDependantCellKillerRadiual3DWithGhostNodesV2::OutputCellKillerParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(DensityDependantCellKillerRadiual3DWithGhostNodesV2)
