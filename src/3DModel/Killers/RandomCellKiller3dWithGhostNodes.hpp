#ifndef RANDOMCELLKILLER3DWITHGHOSTNODES_HPP_
#define RANDOMCELLKILLER3DWITHGHOSTNODES_HPP_
 ...
 */
class RandomCellKiller3dWithGhostNodes : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    RandomCellKiller3dWithGhostNodes(AbstractCellPopulation<3>* pCellPopulation, double probabilityOfDeathInAnHour = 0.5,
    		double minXBoundary = 0.0, double maxXBoundary = 50.0, double minYBoundary = 0.0, double maxYBoundary = 50.0);

	// Destructor
	~RandomCellKiller3dWithGhostNodes();
...
inline void save_construct_data(
    Archive & ar, const RandomCellKiller3dWithGhostNodes * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, RandomCellKiller3dWithGhostNodes * t, const unsigned int file_version)
{
    ...
    ::new(t)RandomCellKiller3dWithGhostNodes(p_tissue);
}
}
}

#endif /* RANDOMCELLKILLER3DWITHGHOSTNODES_HPP_ */
