#ifndef DensityDependantCellKillerStrip3DWithGhostNodes_HPP_
#define DensityDependantCellKillerStrip3DWithGhostNodes_HPP_
 ...
 */
class DensityDependantCellKillerStrip3DWithGhostNodes : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    DensityDependantCellKillerStrip3DWithGhostNodes(AbstractCellPopulation<3>* pCellPopulation, double cut_off = 100.0, double density_threshold = 0.0, double tissueWidth = 10.0, double tissueDepth = 10.0);

	// Destructor
	~DensityDependantCellKillerStrip3DWithGhostNodes();
...
{
/**
 * Serialize information required to construct a DensityDependantCellKillerStrip3DWithGhostNodes.
 */
template<class Archive >
inline void save_construct_data(
    Archive & ar, const DensityDependantCellKillerStrip3DWithGhostNodes * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, DensityDependantCellKillerStrip3DWithGhostNodes * t, const unsigned int file_version)
{
    ...
    ::new(t)DensityDependantCellKillerStrip3DWithGhostNodes(p_tissue);
}
}
}

#endif /*DensityDependantCellKillerStrip3DWithGhostNodes_HPP_*/
