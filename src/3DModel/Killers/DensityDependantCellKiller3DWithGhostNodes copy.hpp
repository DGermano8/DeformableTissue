#ifndef DensityDependantCellKiller3DWithGhostNodes_HPP_
#define DensityDependantCellKiller3DWithGhostNodes_HPP_
 ...
 */
class DensityDependantCellKiller3DWithGhostNodes : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    DensityDependantCellKiller3DWithGhostNodes(AbstractCellPopulation<3>* pCellPopulation, double cut_off = 100.0, double density_threshold = 0.0, double tissueWidth = 10.0, double tissueDepth = 10.0);

	// Destructor
	~DensityDependantCellKiller3DWithGhostNodes();
    ...
    bool IsCellTooSmall(unsigned nodeIndex);
...
{
/**
 * Serialize information required to construct a DensityDependantCellKiller3DWithGhostNodes.
 */
template<class Archive >
inline void save_construct_data(
    Archive & ar, const DensityDependantCellKiller3DWithGhostNodes * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, DensityDependantCellKiller3DWithGhostNodes * t, const unsigned int file_version)
{
    ...
    ::new(t)DensityDependantCellKiller3DWithGhostNodes(p_tissue);
}
}
}

#endif /*DensityDependantCellKiller3DWithGhostNodes_HPP_*/
