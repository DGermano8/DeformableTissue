#ifndef RANDOMCELLKILLER3D_HPP_
#define RANDOMCELLKILLER3D_HPP_
 ...
 */
class RandomCellKiller3d : public AbstractCellKiller<3>
{
private:
...
public:
     ...
     */
    RandomCellKiller3d(AbstractCellPopulation<3>* pCellPopulation, double probabilityOfDeathInAnHour = 0.5,
...
inline void save_construct_data(
    Archive & ar, const RandomCellKiller3d * t, const unsigned int file_version)
{
...
inline void load_construct_data(
    Archive & ar, RandomCellKiller3d * t, const unsigned int file_version)
{
    ...
    ::new(t)RandomCellKiller3d(p_tissue);
}
}
}

#endif /* RANDOMCELLKILLER3D_HPP_ */
