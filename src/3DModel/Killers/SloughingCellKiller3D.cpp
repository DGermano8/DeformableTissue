 ...
 */
SloughingCellKiller3D::SloughingCellKiller3D(AbstractCellPopulation<3>* pCrypt, double cellPopulationWidth, double cellPopulationDepth)
...
SloughingCellKiller3D::~SloughingCellKiller3D()
{
//    mAnoikisOutputFile->close();
}

double SloughingCellKiller3D::GetCellPopulationWidth() const
{
	return mCellPopulationWidth;
}

double SloughingCellKiller3D::GetCellPopulationDepth() const
{
	return mCellPopulationDepth;
}

void SloughingCellKiller3D::SetOutputDirectory(std::string outputDirectory)
{
	mOutputDirectory = outputDirectory;
}

std::string SloughingCellKiller3D::GetOutputDirectory()
{
 ...
 */
std::vector<c_vector<unsigned,2> > SloughingCellKiller3D::RemoveBySloughing()
{
 ...
 * cells
*/
void SloughingCellKiller3D::CheckAndLabelCellsForApoptosisOrDeath()
{
	MeshBasedCellPopulation<3>* p_tissue = static_cast<MeshBasedCellPopulation<3>*> (this->mpCellPopulation);
...
void SloughingCellKiller3D::SetNumberCellsRemovedBySloughing(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
...
unsigned SloughingCellKiller3D::GetNumberCellsRemovedBySloughing()
{
	return mCellsRemovedBySloughing;
}

void SloughingCellKiller3D::SetLocationsOfCellsRemovedBySloughing(std::vector<c_vector<unsigned,2> > cellsRemoved)
{
	MeshBasedCellPopulation<3>* p_tissue = static_cast<MeshBasedCellPopulation<3>*> (this->mpCellPopulation);
...
std::vector<c_vector<double,5> > SloughingCellKiller3D::GetLocationsOfCellsRemovedBySloughing()
{
	return mLocationsOfSloughedCells;
}

void SloughingCellKiller3D::OutputCellKillerParameters(out_stream& rParamsFile)
{
...
CHASTE_CLASS_EXPORT(SloughingCellKiller3D)
