...
template<unsigned DIM>
double PeriodicCryptModelInteractionForce<DIM>::VariableSpringConstantMultiplicationFactor(unsigned nodeAGlobalIndex,
...
//                                                                   AbstractCellPopulation<DIM>& rCellPopulation)
void PeriodicCryptModelInteractionForce<DIM>::AddForceContribution(AbstractCellPopulation<DIM>& rCellPopulation)
{
...
c_vector<double, DIM> PeriodicCryptModelInteractionForce<DIM>::CalculateForceBetweenNodes(unsigned nodeAGlobalIndex,
                                                                                         ...
                                                                                         AbstractCellPopulation<DIM>& rCellPopulation)
{
    assert(dynamic_cast<MeshBasedCellPopulation<DIM>*>(&rCellPopulation) != nullptr);
...
template<unsigned DIM>
double PeriodicCryptModelInteractionForce<DIM>::GetPeriodicDomainWidth()
{
	return mPeriodicDomainWidth;
}

template<unsigned DIM>
void PeriodicCryptModelInteractionForce<DIM>::SetPeriodicDomainWidth(double periodicDomainWidth)
{
	mPeriodicDomainWidth = periodicDomainWidth;
}

template<unsigned DIM>
double PeriodicCryptModelInteractionForce<DIM>::GetPeriodicDomainDepth()
{
	return mPeriodicDomainDepth;
}

template<unsigned DIM>
void PeriodicCryptModelInteractionForce<DIM>::SetPeriodicDomainDepth(double periodicDomainDepth)
{
