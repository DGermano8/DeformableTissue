#ifndef UNIFORMDISTRIBUTIONWNTGENERATIONBASEDCELLCYCLEMODEL_HPP_
#define UNIFORMDISTRIBUTIONWNTGENERATIONBASEDCELLCYCLEMODEL_HPP_
 ...
 *  a normal distribution, as is the case in SimpleWntCellCycleModel. Now this also fixes a maximum
 *  number of generations for the transit cells, to mimic the elimination of cell division that Kaur
 *  and Potten achieve in the 1986 paper.
 */
class UniformDistributionWntGenerationBasedCellCycleModel : public AbstractSimpleCellCycleModel
{
private:
...
public:
     ...
     */
    UniformDistributionWntGenerationBasedCellCycleModel();
...
#endif /* UNIFORMDISTRIBUTIONWNTGENERATIONBASEDCELLCYCLEMODEL_HPP_ */
